...
@section('title', 'Tạo dịch vụ | Diamond Pet')

@section('content_header')
<div style="display: flex;justify-content: space-between;">
    <h1 class="m-0 text-dark">Tạo dịch vụ</h1>
</div>
@stop
            ...
            <div class="row form-area">
                ...
                <div class="col-md-12 form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 col-form-input">
                            <input type="number" name="price" value="{{ old('price') }}" class="form-control" style="width: 40%;" min="0">
                            @if ($errors->has('price'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 col-form-input">
                            <select class="form-select" name="doctor" value="{{ old('doctor') }}" style="width: 40%;">
