    ...
    <div class="container py-4">
        <div class="row gy-5">
            <div class="col-lg-9">
                ...
                <p class="text-muted mb-5">Nếu muốn check lịch sử sản phẩm đã mua có thể chọn các thông tin bên tay phải.</p>
                <!-- PROFILE DETAIL FORM-->
                <form class="py-4" action="/update-profile" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="row" style="margin-left: 0px; height: 38px;">
            ...
            <div class="col-lg-3">
                ...
                <nav class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link text-sm" href="/history"> <i class="me-2 fas fa-list"></i><span>Lịch sử mua hàng</span></a>
                </nav>
            </div>
        </div>
    </div>
